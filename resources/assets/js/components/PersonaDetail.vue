                ...
                <div class="panel">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-2">
                                <!--<div class="thumbnail">-->
                                    <img :src="'/images/users/'+newPersona.imagen" width="100%" height="100%" style="max-width: 129px;max-height: 129px;">
                                <!--</div>-->
                            </div>
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="pull-left">
                                            <h3 class="text-uppercase">
                                                <span v-if="newPersona.estado == 'A' " class="text-primary">{{newPersona.apellido_paterno}} {{newPersona.apellido_materno}}, {{newPersona.nombres}}</span>
                                                <span v-else="" class="text-danger">{{newPersona.apellido_paterno}} {{newPersona.apellido_materno}}, {{newPersona.nombres}}</span>
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="pull-right">
                                            <router-link class="btn btn-primary" :to="{name:'personas'}" ><i class="fa fa-angle-left fa-fw"></i>volver</router-link>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <table class="table">
                                            <tr>
                                                <td><b>F.Nto</b>&nbsp;:</td>
                                                <td class="small">{{moment(newPersona.fecha_nacimiento).format('DD-MM-YYYY')}}</td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <table class="table">
                                            <tr>
                                                <td><b>Estado</b>&nbsp;:</td>
                                                <td>
                                                    <span v-if="newPersona.estado == 'A' " class="text-primary">Activo</span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div v-if="newPersona.estado_civil == 'C' " class="form-control">Casado</div>
                                            <div v-else-if="newPersona.estado_civil == 'V' " class="form-control">Viudo</div>
                                            <div v-else-if="newPersona.estado_civil == 'S' " class="form-control">Soltero</div>
                                            <div v-else-if="newPersona.estado_civil == 'D' " class="form-control">Divorciado</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr v-for="n in 10">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group dropdown btn-group-sm" role="group">
                                                    <button title="detalle" type="button" class="btn btn-default"><i class="fa fa-file fa-fw"></i></button>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <li title="historial">
                                                                <a @click.prevent="fnOpenCloseModal" href ><i class="fa fa-book fa-fw"></i>Historial</a>
                                                            </li>
                                                            <li title="anular">
        ...
        <component :is="'persona-pay-history-modal'" v-if="showModal">
            <div slot="modal-component">
                <div class="modal-header">
                    <button type="button" class="close" @click.prevent="fnOpenCloseModal" ><span aria-hidden="true">&times;</span></button>
